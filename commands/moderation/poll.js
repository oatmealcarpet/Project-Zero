            ...
            args: [
                {
                    ...
                    type: 'string',
                    validate: question => {
                        if (question.length < 1001 && question.length > 1) return true;
                        return 'Polling questions must be between 2 and 1000 characters in length.';
                    }  
                }, 
                {
                    key: 'options',
                ...
                },
                {
                    ...
                    validate: time => {
                        ...
                        return 'Polling time must be between 0 and 1440 minutes(1 Day).';
                    } 
                },
            ]
        });
